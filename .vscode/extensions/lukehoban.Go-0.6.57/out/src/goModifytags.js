...
function addTags(commandArgs) {
    ...
    getTagsAndOptions(vscode.workspace.getConfiguration('go')['addTags'], commandArgs).then(([tags, options, transformValue]) => {
        if (!tags && !options) {
            return;
        }
        if (tags) {
...
function removeTags(commandArgs) {
    ...
    getTagsAndOptions(vscode.workspace.getConfiguration('go')['removeTags'], commandArgs).then(([tags, options]) => {
        if (!tags && !options) {
